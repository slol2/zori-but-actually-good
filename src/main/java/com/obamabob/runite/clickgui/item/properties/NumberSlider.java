...
public class NumberSlider extends Item
{
    ...
    public NumberSlider(final Setting numberProperty) {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        //RuniteTessellator.drawRectDouble(this.x, this.y, this.x + this.getValueWidth(), this.y + this.height, this.isHovering(mouseX, mouseY) ? -1721964477 : 2002577475);
        RuniteTessellator.drawRectGradient(this.x, this.y, this.x + (percentBar * (this.width + 7.4f)), this.y + this.height, ColorUtil.changeAlpha(Runite.rgb, 200), -1);
