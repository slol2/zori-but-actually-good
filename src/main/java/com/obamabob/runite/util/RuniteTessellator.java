...
public class RuniteTessellator extends Tessellator {

    public static RuniteTessellator INSTANCE = new RuniteTessellator();

    public RuniteTessellator() {
        super(0x200000);
    }
...
//        GlStateManager.blendFunc(GlStateManager.SourceFactor.ONE, GlStateManager.DestFactor.ZERO);
    ...
    public static void drawFullBox2(AxisAlignedBB bb, BlockPos blockPos, float width, int red, int green, int blue, int alpha, int alpha2) {
        RuniteTessellator.prepare(GL11.GL_QUADS);
