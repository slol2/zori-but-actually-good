 ...
 * @since 2.0
 */
//This adds the functionality of returning shorts in createNumber()
public class NumberUtil {
    ...
    /**
     * <p><code>NumberUtil</code> instances should NOT be constructed in standard programming.
     * Instead, the class should be used as <code>NumberUtil.toInt("6");</code>.</p>
     *
    ...
    public static Number createNumber(final String str) throws NumberFormatException {
        ...
        if (!Character.isDigit(lastChar) && lastChar != '.') {
            ...
            switch (lastChar) {
                ...
                case 'F' :
                    try {
                        final Float f = NumberUtil.createFloat(str);
                ...
                case 'D' :
                    try {
                        final Double d = NumberUtil.createDouble(str);
        ...
        if (dec == null && exp == null) { // no decimal point and no exponent
            //Must be a Short, Integer, Long, Biginteger
            try {
                return createInteger(str);
            } catch (final NumberFormatException nfe) { // NOPMD
                // ignore the bad number
     ...
     *             use {@link NumberUtil#isCreatable(String)} instead
     */
    @Deprecated
