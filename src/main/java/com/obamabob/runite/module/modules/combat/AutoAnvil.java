...
public class AutoAnvil extends Module {
    ...
    Setting<String> anvilMode = register(new Setting<>("Mode", this, "Pick", new String[]{"Pick", "Feet", "None"}));
    Setting<Double> enemyRange = register(new Setting<>("Range", this, 5.9, 0.0, 6.0));
    Setting<Integer> decrease = register(new Setting<>("Decrease", this, 2, 0,6));
    Setting<Boolean> rotate = register(new Setting<>("Rotate",this,true));
    Setting<Boolean> antiCrystal = register(new Setting<>("Anti Crystal", this, false));
    Setting<Boolean> fastAnvil = register(new Setting<>("Fast Anvil", this, true));
    Setting<Integer> tickDelay = register(new Setting<>("Tick Delay", this, 5,0,10));
    Setting<Integer> blocksPerTick = register(new Setting<>("Blocks Per Tick", this, 4,0,8));
    Setting<Integer> hDistance = register(new Setting<>("H Distance", this, 7,1,10));
    Setting<Integer> minH = register(new Setting<>("Min H", this, 3,1,10));
    Setting<Integer> failStop = register(new Setting<>("Fail Stop", this, 2,1,10));
    Setting<Boolean> chatMsg = register(new Setting<>("Chat Msgs", this, true));
    ...
    private boolean placeBlock(BlockPos pos, int step) {
        ...
        if (step == to_place.size() - 1) {
            ...
            EntityPlayer found = getPlayerFromName(closestTarget.getGameProfile().getName());
