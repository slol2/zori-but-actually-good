...
public class AutoArmor extends Module {
    ...
    Setting<Integer> delay = register(new Setting<Integer>("Delay", 50, 0, 500));
     Setting<Boolean> curse = register(new Setting<Boolean>("Vanishing", false));
     Setting<Boolean> mendingTakeOff = register(new Setting<Boolean>("AutoMend", false));
     Setting<Integer> closestEnemy = register(new Setting<Object>("Enemy", Integer.valueOf(8), Integer.valueOf(1), Integer.valueOf(20), v -> mendingTakeOff.getValue()));
     Setting<Integer> repair = register(new Setting<Object>("Repair%", Integer.valueOf(80), Integer.valueOf(1), Integer.valueOf(100), v -> mendingTakeOff.getValue()));
     Setting<Integer> actions = register(new Setting<Integer>("Packets", 3, 1, 12));
